...
import { setIsCartOpen, setIsMenuOpen } from "@/app/Store/variablesSlice";
...
export default function MobileMenu() {
  ...
  const { isMenuOpen, isCartOpen, width } = useAppSelector(
                ...
                <ul className="flex flex-col gap-4 text-sm mt-5">
                  ...
                  {!user && (
                    <div className="w-full flex flex-col gap-4">
                      ...
                      <li className="w-full">
                        <button
                          className="rounded-md text-left w-full block bg-gray-200 text-gray-400 hover:bg-primary hover:text-white duration-200 px-5 py-2.5 text-sm font-medium "
